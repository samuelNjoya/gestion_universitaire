                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">                                            
                                        ...
                                        @if (!empty($getSchool->getProfile()))
                                           <img style="border-radius: 50%" width="60px" height="60px"  src="{{ $getSchool->getProfile() }}" alt="">
                                        @endif                                       
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-xs-12">                                            
                                        <textarea class="form-control" rows="5" name="address" >{{ old('address', $getSchool->address) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">                                                                                                                                        
                                        <select name="status" id="" class="form-control">
                                            ...
                                            <option {{ ($getSchool->status == 0) ? 'selected' : '' }} value="0">onactive</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
