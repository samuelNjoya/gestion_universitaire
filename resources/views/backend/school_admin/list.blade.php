                                ...
                                <tbody>
                                    ...
                                    @forelse ($getRecord as $item)                                 
                                        <tr >
                                            ...
                                            <td>
                                                <a href="{{ url('panel/school_admin/edit', $item->id) }}" class="btn btn-default  btn-sm"><span class="fa fa-pencil"></span></a>
                                                <a href="{{ url('panel/school_admin/delete', $item->id) }}" onclick="return confirm('Are you sure do you want to delete ?');" class="btn btn-danger  btn-sm" ><span class="fa fa-times"></span></a>
                                            </td>
                                        </tr> 
                                    @empty
                                          <tr>
