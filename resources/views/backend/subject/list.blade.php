                                ...
                                <tbody>
                                    ...
                                    @forelse ($getRecord as $item)                                 
                                        <tr >
                                            ...
                                            <td>
                                                <a href="{{ url('panel/subject/edit', $item->id) }}" class="btn btn-default  btn-sm"><span class="fa fa-pencil"></span></a>
                                                <a href="{{ url('panel/subject/delete', $item->id) }}" onclick="return confirm('Are you sure do you want to delete ?');" class="btn btn-danger  btn-sm" ><span class="fa fa-times"></span></a>
                                            </td>
                                        </tr> 
                                    @empty
                                          <tr>
