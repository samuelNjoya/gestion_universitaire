            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        ...
                        <a href="{{url('panel/student/create')}}" class="btn btn-primary pull-right">Create Student</a>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    @forelse ($getRecord as $item)                                 
                                        <tr >
                                            ...
                                            <td >
                                                {{-- {{$item->getClass->name}} --}}
                                                {{ $item->getClass ? $item->getClass->name : 'Classe non disponible' }}
                                            </td>
                                            <td >{{$item->address}}</td>
                                            ...
                                            <td>
                                                <a href="{{ url('panel/student/edit', $item->id) }}" class="btn btn-default btn-rounded btn-sm"><span class="fa fa-pencil"></span></a>
                                                <a href="{{ url('panel/student/delete', $item->id) }}" onclick="return confirm('Are you sure do you want to delete ?');" class="btn btn-danger btn-rounded btn-sm" ><span class="fa fa-times"></span></a>
                                            </td>
                                        </tr> 
                                    @empty
                                          <tr>
